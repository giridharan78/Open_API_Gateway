...
[OAuth_CertApi1 : Browser Emulation]
...
ProxyHost=
ProxyPort=
[OAuth_CertApi1 : Options\Connection]
Speed for LG=
Speed for PC=
...
[OAuth_CertApi1 : FunctionalTesting]
...
JavaFull=0
JavaOptimized=0
[OAuth_CertApi1 : PassFailDefinition]
definitionType=1
checkErrors=0
checkSevere=1
checkStopTest=0
...
ruleCheck=15
warningNum=15
[OAuth_CertApi1 : SleepTimeControl]
sleepControlType=1
timeBetween=2
timeAnd=10
deviationPersent=10
[OAuth_CertApi1 : BrowserDialogs]
...
[OAuth_CertApi1 : EmulationPlayback]
useHistory=0
historyLimit=1
csjsRecovery=1
[OAuth_CertApi1 : Java]
strSelectedJVM=Default
[OAuth_CertApi1 : WebServices]
sBasicPassword=
sUserName=
sProxyHost=
sProxyPassword=
...
sProxyPort=
nWSClientType=1
[OAuth_CertApi1 : ResetMechanism]
bResetEnable=0
nCreateLGRetryTimes=3
nLGTimeout=150
nResetTimeout=60
nStopLGTimeout=3
[OAuth_CertApi1 : HTTPParameters]
bHTTPVersion=1
bMultiIPSupport=0
bEncodeFormData=1
bAcceptLanguage=0
StrAcceptLanguage=
[OAuth_CertApi1 : BrowserCache]
bFilterApplets=1
bFilterImages=1
bFilterJSFiles=1
...
[TotalDefault Report]
Type=Web
Measurements=Load Size;;Hits Per Second;;Throughput (Bytes Per Second);;
